...
Notice that the solution set must not contain duplicate triplets.`,
    ...
    <br> 3. O(n) если проходить по циклу, испольозвать указатель слева и справа, и двигать его пока не найдем сумму или колво. Двигать - если сумма больше, двигаем конец меньше, если меньше - то начало ближе к концу.
        ...
        },
        {
            ...
            remember: `
            Пройтись слева направо, получая максимум на текущий момент и записывая в массив. Аналогично справа налево. Для получения, сколько воды на текущем моменте, берем минимум из двух массивов и вычитываем текущее колво блоков, это поможет понять, сколько воды можно сохранить.

            <br> находим bottle neck

            ЛИБО

            <br>
            Проходимся двумя указателями с двух концов к середине. Определяем максимум для обоих указателей до текущего их положения. Текущее колво воды - максимум который был минус текущее положение.
